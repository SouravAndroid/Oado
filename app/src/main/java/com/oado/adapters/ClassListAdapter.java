...
public class ClassListAdapter extends RecyclerView.Adapter<ClassListAdapter.MyViewHolder>
    ...
    private ArrayList<ClassData> originalList;
    private ArrayList<ClassData> filteredArrayList;
    private ArrayList<Boolean> booleanArrayList;
    private ProgressDialog progressDialog;
    private UserPermissionCheck userPermissionCheck;


    public ClassListAdapter(Context context, ArrayList<ClassData> itemList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        private TextView tv_name, tv_head;
    ...
    public MyViewHolder onCreateViewHolder(@Nullable ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.class_listitem, parent, false);
    ...
    public void onBindViewHolder(@Nullable MyViewHolder holder, final int position) {
        ...
        ClassData classData = filteredArrayList.get(position);

        holder.tv_name.setText(classData.getName());
        holder.tv_head.setText(Commons.getFirstChar(classData.getName()).toUpperCase());
        ...
        holder.rel_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClassData classData1 = filteredArrayList.get(position);

                Intent intent = new Intent(context, ClassAdd.class);
                intent.putExtra("user_data", classData1); //pass bundle to your intent
        ...
        holder.rel_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                deleteDialog(classData1.getId(), classData1.getInstitute_id());
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (ClassData row : originalList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                if (charSequence != null) {
                    ...
                    filteredArrayList = (ArrayList<ClassData>) filterResults.values;
    ...
    private void deleteSection(final String id, String institute_id){
        ...
        String url = ApiClient.delete_class;
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();

        params.put(ApiClient.class_id, id);
        params.put(ApiClient.institute_id, institute_id);

        Log.d(Constants.TAG , "delete_class - " + url);
        Log.d(Constants.TAG , "delete_class - " + params.toString());
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d(Constants.TAG, "delete_class- " + response.toString());
