...
import com.oado.activity.TeacherAdd;
...
public class TeacherListAdapter extends RecyclerView.Adapter<TeacherListAdapter.MyViewHolder>
    ...
    private ArrayList<TeacherData> originalList;
    private ArrayList<TeacherData> filteredArrayList;
    private ArrayList<Boolean> booleanArrayList;
    private ProgressDialog progressDialog;
    private UserPermissionCheck userPermissionCheck;


    public TeacherListAdapter(Context context, ArrayList<TeacherData> itemList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.teacher_listitem, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final TeacherData teacherData = filteredArrayList.get(position);

        holder.tv_name.setText(teacherData.getName());
        holder.textView2.setText("Contact no: "+teacherData.getMobile()
                + "\n" + "Subject: "+teacherData.getSubject_name());


        Picasso.with(context).load(teacherData.getImage()).placeholder(R.mipmap.no_image)
        ...
        holder.rel_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TeacherData teacherData1 = filteredArrayList.get(position);

                Intent intent = new Intent(context, TeacherAdd.class);
                intent.putExtra("user_data", teacherData1); //pass bundle to your intent
        ...
        holder.rel_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TeacherData teacherData1 = filteredArrayList.get(position);
                deleteDialog(teacherData1.getId());
            }
        });
        ...
        holder.item_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogImage dialogImage = new DialogImage(context, teacherData.getImage());
                dialogImage.show();
            }
        });
        ...
        holder.rel_send_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id", teacherData1.getId());
                intent.putExtra("name", teacherData1.getName());
        ...
        ///// permission ... rel_view, rel_edit, rel_delete, rel_send_message
        ...
        if (userPermissionCheck.isAdmin() || userPermissionCheck.isInstitute()){
          ...
          //  holder.rel_action_view.setVisibility(View.GONE);
            ...
            holder.rel_view.setVisibility(View.GONE);
        ...
        }else if (userPermissionCheck.isStudent() || userPermissionCheck.isGuardian()){
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (TeacherData row : originalList) {

                        // here we are looking for name or phone number match
                        if (row.getName().toLowerCase().contains(charString.toLowerCase())
                                || row.getMobile().contains(charSequence)
                                || row.getSubject_name().contains(charString.toLowerCase())) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                if (charSequence != null) {
                    ...
                    filteredArrayList = (ArrayList<TeacherData>) filterResults.values;
    ...
    private void deleteTeacher(final String id){
        ...
        String url = ApiClient.delete_teacher;
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();

        params.put(ApiClient.teacher_id, id);

        Log.d(Constants.TAG , "delete_teacher - " + url);
        Log.d(Constants.TAG , "delete_teacher - " + params.toString());
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d(Constants.TAG, "delete_teacher- " + response.toString());
            ...
            public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                Log.d(Commons.TAG, "delete_teacher- " + res);
                progressDialog.dismiss();
