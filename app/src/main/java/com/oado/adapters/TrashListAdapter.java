...
public class TrashListAdapter extends RecyclerView.Adapter<TrashListAdapter.MyViewHolder>
    ...
    public TrashListAdapter(Context context, ArrayList<String> itemList) {
