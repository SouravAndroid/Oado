...
public class TimeSlotsListAdapter extends RecyclerView.Adapter<TimeSlotsListAdapter.MyViewHolder>
    ...
    public TimeSlotsListAdapter(Context context, ArrayList<TimeSlotData> itemList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        private TextView tv_head, tv_name, textView2, textView3, textView4, textView5;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tv_name.setText(timeSlotData.getSubject_name());
        ...
        holder.textView4.setText("Teacher : "+timeSlotData.getTeacher_name());

        //holder.textView5.setText("Days: "+timeSlotData.getWeek_days());

        setInTextView(holder.textView5, timeSlotData.getWeek_days());
                ...
                if (charString.isEmpty()) {
                    ...
                    for (TimeSlotData row : originalList) {
                        ...
                        if (row.getClass_name().toLowerCase().contains(charString.toLowerCase())
                                ...
                                || row.getTeacher_name().toLowerCase().contains(charString.toLowerCase())) {
    ...
    private void setInTextView(TextView textView, String week_days){

        String[] array = week_days.split(",");
        ...
        for (int i = 0; i < arrayListDays.size(); i++){
            ...
            for (int j = 0; j < preSelectedDaysList.size(); j++){
                if (arrayListDays.get(i).get("name").toLowerCase()
                        .matches(preSelectedDaysList.get(j).toLowerCase())){

                    days = days + arrayListDays.get(i).get("name") + ", ";
