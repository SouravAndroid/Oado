...
import com.oado.adapters.TeacherListAdapter;
...
public class Teacher extends Fragment implements SearchView.OnQueryTextListener {
    public Teacher() { }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.frag_teacher, container, false);
    ...
    private void initViews(View view){
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), TeacherAdd.class);
                ...
                if (response != null) {
                    try {
                        ...
                        if (status == 1){
                            ...
                            teacherListAdapter = new TeacherListAdapter(getActivity(), listTeacher);
                            recycler_view.setAdapter(teacherListAdapter);
                            filter = teacherListAdapter.getFilter();

                            if (listTeacher.size() > 10){
                                searchView.setVisibility(View.VISIBLE);
                            }else {
                                searchView.setVisibility(View.GONE);
                            }
