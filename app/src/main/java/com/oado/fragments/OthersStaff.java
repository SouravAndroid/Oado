...
import com.oado.adapters.OthersStaffListAdapter;
...
public class OthersStaff extends Fragment implements SearchView.OnQueryTextListener{
    public OthersStaff() { }
    ...
    OthersStaffListAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.frag_others_staff, container, false);
    ...
    private void initViews(View view){
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), OthersStaffAdd.class);
                    ...
                    try {
                        ...
                        if (status == 1){
                            ...
                            for (int i = 0; i < info.length(); i++){
                                ...
                                if (userPermissionCheck.isStaff()){
                            ...
                            adapter = new OthersStaffListAdapter(getActivity(), listStaff);
