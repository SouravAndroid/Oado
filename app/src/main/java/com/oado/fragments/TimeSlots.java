...
public class TimeSlots extends Fragment implements SearchView.OnQueryTextListener {
                    ...
                    try {
                        ...
                        if (status == 1){
                            ...
                            for (int i = 0; i < info.length(); i++){
                                ...
                                timeSlotData.setTeacher_id(object.optString("teacher_id"));
                                timeSlotData.setTeacher_name(object.optString("teacher_name"));
                                ...
                                if (userPermissionCheck.isStudent()
                                    ...
                                    if (prefManager.getClass_id()
                                            .equals(object.optString("class_id"))
                                            && prefManager.getSection_id()
                                            .equals(object.optString("section_id"))){
                                    ...
                                    if (prefManager.getId()
                                            .equals(object.optString("teacher_id"))){
