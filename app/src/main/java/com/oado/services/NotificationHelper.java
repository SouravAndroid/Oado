...
import com.oado.R;
import com.oado.activity.NotificationActivity;
...
public class NotificationHelper {
    ...
    public void createNotification(String title, String message)
    {
        ...
        mBuilder.setSmallIcon(R.mipmap.oado_launcher);
    ...
    public void createNotificationForNotiFrag(String title, String message)
    {
        /**Creates an explicit intent for an Activity in your app**/
