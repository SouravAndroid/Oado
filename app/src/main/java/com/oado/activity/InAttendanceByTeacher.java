...
import com.oado.R;
import com.oado.adapters.AttendanceListAdapter;
...
public class InAttendanceByTeacher extends AppCompatActivity {

    @BindView(R.id.recycler_view) RecyclerView recycler_view;
    @BindView(R.id.present_submit) Button present_submit;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attendence_by_teacher);
    ...
    public void initViews(){
        ...
        present_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (attendanceListAdapter != null){

                    if (attendanceListAdapter.getReasonDataArrayList().size() == 0){
                        Toasty.info(getApplicationContext(),
                                "You are not selected any student!",
                  ...
                  //  Log.d(Commons.TAG, "data = "+createJsonString());
    ...
    private void setClassData(){
        ...
        if (globalClass.getListClass().size() == 0){
            ...
            spinnerAdapter = new MySpinnerAdapter(InAttendanceByTeacher.this,
                    list_Class);
    ...
    private void getAllStudentsWithAttendanceStatus(){
        ...
        String url = ApiClient.get_attendance_list;
        ...
        Log.d(Constants.TAG , "get_attendance_list - " + params.toString());
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d(Constants.TAG, "get_attendance_list- " + response.toString());
                    ...
                    try {
                        ...
                        if (status == 1){
                            ...
                            for (int i = 0; i < info.length(); i++){
                                ...
                                if (object.optInt("attendance_status") == 0){
                                    ...
                                    studentData.setAttendance_status(object.optInt("attendance_status"));
                            ...
                            if (listStudent.size() == 0){
                                Toasty.info(getApplicationContext(),
                                        "No student found for attendance",
                                        Toast.LENGTH_LONG, true).show();
            ...
            public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                Log.d(Commons.TAG, "get_attendance_list- " + res);
                progressDialog.dismiss();

                android.app.AlertDialog alert =
                        new android.app.AlertDialog.Builder(InAttendanceByTeacher.this).create();
    ...
    private void sortingData(){
        ...
        attendanceListAdapter = new AttendanceListAdapter(this, listStudent, present_submit);
        recycler_view.setAdapter(attendanceListAdapter);
    }


    private String createJsonString(){

        ArrayList<AttendanceReasonData> reasonDataArrayList;
        JSONArray jsonArray = new JSONArray();

        if (attendanceListAdapter != null){

            reasonDataArrayList = attendanceListAdapter.getReasonDataArrayList();

            try {

                for (int i = 0; i < reasonDataArrayList.size(); i++){

                    AttendanceReasonData data = reasonDataArrayList.get(i);

                    JSONObject object1 = new JSONObject();

                    object1.put("student_id", data.getStu_id());
                    object1.put("attendence_type", data.getAtten_type());
                    object1.put("attendence_date", data.getAtten_date());
                    object1.put("attendence_time", data.getAtten_time());
                    object1.put("late_time", data.getLate_time());
                    object1.put("reason", data.getReason());
    ...
    private void submitAttendanceStatus(){

        progressDialog.show();

        present_submit.setVisibility(View.GONE);

        String url = ApiClient.add_attendance_by_teacher;
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        ...
        params.put(ApiClient.class_id, class_id);
        params.put(ApiClient.section_id, section_id);
        params.put(ApiClient.student_arr, createJsonString());


        Log.d(Constants.TAG , "add_attendance_by_teacher - " + url);
        Log.d(Constants.TAG , "add_attendance_by_teacher - " + params.toString());
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
            ...
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                Log.d(Constants.TAG, "add_attendance_by_teacher- " + response.toString());
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                Log.d(Commons.TAG, "add_attendance_by_teacher- " + res);
                progressDialog.dismiss();
