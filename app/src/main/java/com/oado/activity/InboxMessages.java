...
public class InboxMessages extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_inbox);
    ...
    public void initViews(){
        ...
        fab_sent_message = findViewById(R.id.fab_sent_message);
        ...
        client.post(url, params, new JsonHttpResponseHandler() {
                ...
                if (response != null) {
                    try {
                        ...
                        if (status == 1){
                            ...
                            inboxListAdapter = new InboxListAdapter(InboxMessages.this, list_Diary);
            ...
            public void onFailure(int statusCode, Header[] headers, String res, Throwable t) {
                ...
                android.app.AlertDialog alert =
                        new android.app.AlertDialog.Builder(InboxMessages.this).create();
